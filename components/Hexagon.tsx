...
const Hexagon: React.FC<HexagonProps> = ({ role, isActive, isLocked, onClick, onHover, width = 120 }) => {
  ...
  return (
    <motion.div
      className="relative flex items-center justify-center cursor-pointer select-none group outline-none"
