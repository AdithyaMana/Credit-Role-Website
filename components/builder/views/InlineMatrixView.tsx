            ...
            <table className="min-w-full divide-y divide-red-100">
                ...
                <tbody className="divide-y divide-red-100 font-sans bg-white/50">
                    {contributors.map(contributor => (
                        <tr key={contributor.id} className="hover:bg-red-50/50 transition-colors">
                            ...
                            {creditRoles.map(role => {
                                ...
                                return (
                                    <td key={role.id} className="px-2 py-2 text-center text-red-600 font-bold text-xs bg-white/30 border-l border-red-50">
                                        {hasRole ? (
